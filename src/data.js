...
export const experiences = [
  ...
  },
  {
    ...
    "role_id": "ADI Computer · Magang Teknisi Komputer dan Jaringan",
    "role_zh": "ADI Computer · 计算机与网络技术实习生",
    "role_ja": "ADI Computer · コンピュータ・ネットワーク技術インターン",
    "role_ko": "ADI Computer · 컴퓨터 및 네트워크 기술 인턴",
    "logo": "",
...
export const projects = [
  {
    ...
    "overview": "A complaint system focused on analyzing reports using AI, equipped with multiple role access management tailored for school needs.",
    "overview_id": "Sistem pengaduan yang berfokus pada analisis keluhan menggunakan AI, dilengkapi dengan manajemen akses multi-role yang disesuaikan untuk kebutuhan sekolah.",
    "overview_zh": "一个专注于使用AI分析投诉的系统，配备了为学校需求量身定制的多角色访问管理。",
  ...
  },
  {
    ...
    "overview": "<p>Building a personal portfolio that is quickly understood by recruiters and clients, showcasing technical thinking and attention to UI details.</p>",
    "overview_id": "<p>Membangun portofolio pribadi yang cepat dipahami rekruter dan klien, menunjukkan cara berpikir teknis dan perhatian terhadap detail UI.</p>",
    "overview_zh": "<p>建立一个招聘人员和客户能快速理解的个人作品集，展示技术思维和对UI细节的关注。</p>",
  ...
  },
  {
    ...
    "overview": "Developed comprehensive digital invitation solutions allowing users to manage guest lists, RSVPs, and display event details with beautiful layouts.",
    "overview_id": "Mengembangkan solusi undangan digital komprehensif yang memungkinkan pengguna mengelola daftar tamu, RSVP, dan menampilkan detail acara dengan tata letak yang indah.",
    "overview_zh": "开发了全面的数字邀请解决方案，允许用户管理客人名单、RSVP并以精美的布局显示活动详细信息。",
  ...
  },
  {
    ...
    "overview": "A data science project analyzing user reviews of online lending apps to automatically extract aspects and sentiments using topic modeling (LDA) and NLP (IndoBERT).",
    "overview_id": "Proyek data science yang menganalisis ulasan pengguna aplikasi pinjaman online untuk mengekstrak aspek dan sentimen secara otomatis menggunakan pemodelan topik (LDA) dan NLP (IndoBERT).",
    "overview_zh": "一个数据科学项目，分析在线贷款应用的用户评论，使用主题建模（LDA）和NLP（IndoBERT）自动提取方面和情感。",
