...
export const experiences = [
  {
    ...
    points: ['Mengembangkan website portofolio dan landing page yang responsif', 'Menghubungkan frontend, backend, database, dan deployment dalam satu alur kerja', 'Berkolaborasi dengan stakeholder untuk menerjemahkan kebutuhan menjadi solusi teknis'],
  ...
  },
  {
    ...
    points: ['Mendalami pengembangan web, basis data, dan struktur data', 'Mengerjakan project akademik dengan pendekatan solusi nyata', 'Bereksperimen dengan AI tools, server infrastructure, dan automation'],
