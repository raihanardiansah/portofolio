              ...
              <div key={p.slug} className="flex flex-col rounded-2xl border border-zinc-200/80 dark:border-zinc-700/50 bg-white dark:bg-zinc-800/50 p-5 hover:border-black dark:hover:border-white/40 hover:shadow-xl hover:scale-[1.01] transition-all duration-200">
                ...
                <div className="mt-auto pt-4 border-t border-zinc-100 dark:border-zinc-700/50 flex flex-wrap items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {p.githubUrl && (
                      <a href={p.githubUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-1 text-[11px] font-mono px-2 py-1 rounded bg-zinc-100 dark:bg-zinc-700 text-zinc-600 dark:text-zinc-300 hover:bg-zinc-200 dark:hover:bg-zinc-600 transition-colors" aria-label={`${p.title} source code on GitHub`}>
                    ...
                    {p.liveUrl && (
                      <a href={p.liveUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center text-[11px] font-mono px-2 py-1 rounded bg-zinc-100 dark:bg-zinc-700 text-zinc-600 dark:text-zinc-300 hover:bg-zinc-200 dark:hover:bg-zinc-600 transition-colors" aria-label={`${p.title} live demo`}>Live ↗</a>
                    )}
                  </div>
                </div>
              </div>
